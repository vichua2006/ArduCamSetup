...
# wheel files can be found at http://biodev.ece.ucsb.edu:4040/bisque/dev/+simple/arducam-rgbir-remosaic
# however they are all amd based; maybe try directly on pi?
